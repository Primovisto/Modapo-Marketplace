...
class WorkerClass(Setting):
    ...
    desc = """\
        ...
        * ``tornado``  - Requires tornado >= 0.2
        ...
        Python path to a subclass of ``gunicorn.workers.base.txt.Worker``.
...
class Umask(Setting):
    ...
    desc = """\
        ...
        with ``int(value, 0)`` (``0`` means Python guesses the base.txt, so values
...
class Procname(Setting):
    ...
    default = None
    desc = """\
        A base.txt to use with setproctitle for process naming.
