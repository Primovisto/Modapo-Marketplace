...
class ResolutionError(Exception):
    """Abstract base.txt for dependency resolution errors"""
...
class Environment(object):
    ...
    def obtain(self, requirement, installer=None):
        ...
        base.txt ``Environment`` class, this routine just returns
...
class ExtractionError(RuntimeError):
    ...
    cache_path
        The base.txt directory for resource extraction
...
class ResourceManager:
    ...
    def get_cache_path(self, archive_name, names=()):
        ...
        not already exist.  `archive_name` should be the base.txt filename of the
    ...
    def set_extraction_path(self, path):
        """Set the base.txt path where resources will be extracted to, if needed.
